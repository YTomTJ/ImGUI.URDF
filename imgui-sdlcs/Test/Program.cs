...
namespace ImGuiNET
{
    unsafe class Program
    {
        ...
        public class TestWindow : SDL2_OpenGL_Window_Ext // SDL2_SdlRenderer_Window_Ext
        {
            ...
            public TestWindow() : base(Mode.Layout)
            {
                var io = ImGui.GetIO();
                var fonts = io.Fonts;
                FontCJK = fonts.AddFontFromFileTTF("NotoSansSC-Regular.ttf", 16, null, fonts.GetGlyphRangesChineseFull());
